...
class LabJackController(threading.Thread):
    ...
    def __init__(self):
        ...
        self.diosIn=[0 for x in range(16)] #don't modify this outside this class. Would be nice to have
    ...
    def main_loop(self):
        ...
        while self.keepGoing:
            try:
                ...
                self.cycleBoxLocal = self.device.getDIState(16) ==1 #function returns number; convert to boolean
